...
def main():
    ...
    shipping_goal.pose.position.x = 0.942255  # Replace with the x-coordinate from the log
    shipping_goal.pose.position.y = -3.25139  # Replace with the y-coordinate from the log
    shipping_goal.pose.orientation.z = -0.99977  # Replace with the z-coordinate from the log
    shipping_goal.pose.orientation.w = 0.0214511  # Replace with the w-coordinate from the log
